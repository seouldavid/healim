...
<body>
	...
	<div class="container">
		...
		<form method="post" enctype="multipart/form-data"
			action="/boardOneListIssueOk">
			<h2>게시물 신고 : "${mvo.wr_subject}"</h2>
			...
			<table>
				...
				<tbody>
					...
					<select id="reportReason" name="issue_option">
						<option value="욕설" selected>욕설</option>
						<option value="광고성/도박">광고성/도박</option>
						<option value="음란물">음란물</option>
						<option value="기타">기타</option>
					</select>
					<br>
					<br>
					<textarea id="issuePost" name="issue_post" rows="10" cols="100"
						placeholder="신고할 내용을 입력해주세요."
						style="text-align: left; vertical-align: top; padding: 0; margin: 0;"></textarea>

					<script>
						// textarea가 포커스를 받을 때마다 커서를 맨 위로 고정
						document.getElementById('issuePost').addEventListener(
								'focus', function() {
					...
					<input type="button" value="취소"
						onclick="location.href='/boardOneList?wr_id=${mvo.wr_id}&bbs_id=${mvo.bbs_id}'">
					<%-- </c:if> --%>
